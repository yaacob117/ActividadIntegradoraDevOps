                ...
                <div class="card wdt-changelog-card">
                    ...
                    <div class="card-body card-padding">
                        ...
                        <div class="alert alert-info m-b-0" role="alert">
                            ...
                            <ul>
                                <li><strong>NEW FREE addon:</strong> “wpDataTables integration for Forminator Forms” available. Tool that adds “Forminator Form” as a new table type and allows you to create wpDataTables from Forminator Forms submissions. More on this <a href="https://wordpress.org/plugins/wpdatatables-forminator/" target="_blank">link</a>.</li>
                                <li><strong>Improvement:</strong> Added new hooks: wpdatatables_excel_before_frontend_edit_row,
                                    wpdatatables_filter_int_cell_data_in_charts, wpdatatables_filter_float_cell_data_in_charts
                                    and wpdatatables_filter_total_length_query..</li>
                                <li><strong>BugFix:</strong> Fixed layout of date, datetime and timepicker for different skins.</li>
                                <li><strong>BugFix:</strong> Fixed layout of copy to clipboard element.</li>
                                <li><strong>BugFix:</strong> Fixed layout of edit popover in Material skin.</li>
                                <li><strong>BugFix:</strong> Fixed issue with Number range slider filter when min and max values are the same.</li>
                                <li><strong>BugFix:</strong> Fixed issue with translate "nothingSelected" string in select-boxes(in filters and edit modal).</li>
                                <li><strong>BugFix:</strong> Fixed layout of date, datetime and time picker in filters in header and footer when option Scrollable is used.</li>
                                <li><strong>BugFix:</strong> Fixed layout of table when Number range slider filter is in footer of the table and Scrollable option is used.</li>
                                <li><strong>BugFix:</strong> Fixed issue with select-box, multi select-box and date/time picker overlapping in edit modal when HTML editor is used.</li>
                                ...
                                <li><strong>BugFix:</strong> Fixed conflict on back-end with Gravity forms tooltips if Gravity integration add-on is not installed.</li>
                                <li><strong>BugFix:</strong> Fixed issue with rendering link column in Highcharts.</li>
                                <li><strong>BugFix:</strong> Removed deprecated function from style_block.inc.php file.</li>
                                <li>Compatibility with WordPress 5.7.2 approved.</li>
